...
// Create Deal
func (r *DealService) New(ctx context.Context, params DealNewParams, opts ...option.RequestOption) (res *DealNewResponse, err error) {
...
// Update Deal
func (r *DealService) Update(ctx context.Context, dealID string, params DealUpdateParams, opts ...option.RequestOption) (err error) {
	opts = slices.Concat(r.Options, opts)
...
type DealNewResponse struct {
	ID   string              `json:"id" format:"uuid"`
	JSON dealNewResponseJSON `json:"-"`
}

// dealNewResponseJSON contains the JSON metadata for the struct [DealNewResponse]
type dealNewResponseJSON struct {
	ID          apijson.Field
	raw         string
	ExtraFields map[string]apijson.Field
}

func (r *DealNewResponse) UnmarshalJSON(data []byte) (err error) {
	return apijson.UnmarshalRoot(data, r)
}

func (r dealNewResponseJSON) RawJSON() string {
	return r.raw
}
