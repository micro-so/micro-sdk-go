...
func DefaultClientOptions() []option.RequestOption {
	...
	if o, ok := os.LookupEnv("MICRO_API_KEY"); ok {
		defaults = append(defaults, option.WithAPIKey(o))
	}
	if o, ok := os.LookupEnv("MICRO_CUSTOM_HEADERS"); ok {
...
// environment (MICRO_API_KEY, MICRO_BASE_URL). The option passed in as arguments
...
func NewClient(opts ...option.RequestOption) (r *Client) {
	...
	r.Identities = NewIdentityService(opts...)
	r.Deals = NewDealService(opts...)
