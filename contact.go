...
// Create object
func (r *ContactService) New(ctx context.Context, params ContactNewParams, opts ...option.RequestOption) (res *PrismObjectProperties, err error) {
...
// Patch object
func (r *ContactService) Update(ctx context.Context, contactID string, params ContactUpdateParams, opts ...option.RequestOption) (res *PrismObjectProperties, err error) {
	opts = slices.Concat(r.Options, opts)
	precfg, err := requestconfig.PreRequestOptions(opts...)
	if err != nil {
		return nil, err
