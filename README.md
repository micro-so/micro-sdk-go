...
func main() {
	...
	prismObjectProperties, err := client.Prism.NewObject(
		context.TODO(),
...
client.Prism.NewObject(context.TODO(), ...,
	// Override the header
...
`*micro.Error`. This contains the `StatusCode`, `*http.Request`, and
...
if err != nil {
	...
	panic(err.Error()) // GET "/v2/prism/{teamId}/{objectType}": 400 Bad Request { ... }
}
```
...
We also provide a helper `micro.FileParam(reader io.Reader, filename string, contentType string)`
