...
func TestPrismObjectContactDelete(t *testing.T) {
	t.Skip("Mock server tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
...
func TestPrismObjectContactDuplicate(t *testing.T) {
	t.Skip("Mock server tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
...
func TestPrismObjectContactGet(t *testing.T) {
	t.Skip("Mock server tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.Prism.Objects.Contacts.Query(context.TODO(), micro.PrismObjectContactQueryParams{
		Query: micro.F(micro.PrismObjectContactQueryParamsQuery{
			...
			Filter: micro.F([]map[string]micro.PrismObjectContactQueryParamsQueryFilterUnion{{
				"foo": micro.PrismObjectContactQueryParamsQueryFilter{
					Equals: micro.F[micro.PrismObjectContactQueryParamsQueryFilterUnion](shared.UnionString("string")),
				},
			}}),
...
func TestPrismObjectContactRestore(t *testing.T) {
	t.Skip("Mock server tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
