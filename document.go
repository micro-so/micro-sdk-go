...
// Create object
func (r *DocumentService) New(ctx context.Context, params DocumentNewParams, opts ...option.RequestOption) (res *PrismObjectProperties, err error) {
...
// Patch object
func (r *DocumentService) Update(ctx context.Context, documentID string, params DocumentUpdateParams, opts ...option.RequestOption) (res *PrismObjectProperties, err error) {
	opts = slices.Concat(r.Options, opts)
	precfg, err := requestconfig.PreRequestOptions(opts...)
	if err != nil {
		return nil, err
