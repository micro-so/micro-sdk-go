...
func TestWebhookNewWithOptionalParams(t *testing.T) {
	...
	_, err := client.Webhooks.New(context.TODO(), micro.WebhookNewParams{
...
func TestWebhookList(t *testing.T) {
	...
	_, err := client.Webhooks.List(context.TODO(), micro.WebhookListParams{})
	if err != nil {
		var apierr *micro.Error
		if errors.As(err, &apierr) {
			t.Log(string(apierr.DumpRequest(true)))
...
func TestWebhookListDeliveriesWithOptionalParams(t *testing.T) {
	...
	_, err := client.Webhooks.ListDeliveries(context.TODO(), micro.WebhookListDeliveriesParams{
		Cursor: micro.F("cursor"),
		Limit:  micro.F(int64(1)),
		Status: micro.F(micro.WebhookListDeliveriesParamsStatusSuccess),
		Type:   micro.F(micro.WebhookListDeliveriesParamsTypeDelivery),
	})
	if err != nil {
		var apierr *micro.Error
		if errors.As(err, &apierr) {
...
func TestWebhookPingWithOptionalParams(t *testing.T) {
	t.Skip("Mock server tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.Webhooks.Ping(
		context.TODO(),
		"182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
		micro.WebhookPingParams{
			Data: micro.F(map[string]interface{}{
				"foo": "bar",
			}),
			Event: micro.F("event"),
		},
