...
// RequestOption is an option for the requests made by the micro API Client
// which can be supplied to clients, services, and methods. You can read more about this functional
// options pattern in our [README].
//
// [README]: https://pkg.go.dev/github.com/stainless-sdks/micro-go#readme-requestoptions
...
func WithEnvironmentProduction() RequestOption {
	return requestconfig.WithDefaultBaseURL("https://developers.micro.so/")
}
...
// WithTeamID returns a RequestOption that sets the client setting "team_id".
func WithTeamID(value string) RequestOption {
