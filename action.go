...
// Create object
func (r *ActionService) New(ctx context.Context, params ActionNewParams, opts ...option.RequestOption) (res *PrismObjectProperties, err error) {
...
// Patch object
func (r *ActionService) Update(ctx context.Context, actionID string, params ActionUpdateParams, opts ...option.RequestOption) (res *PrismObjectProperties, err error) {
	opts = slices.Concat(r.Options, opts)
	precfg, err := requestconfig.PreRequestOptions(opts...)
	if err != nil {
		return nil, err
